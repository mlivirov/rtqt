...
public:
    ...
    inline void fillFromFindData(WIN32_FIND_DATAA &findData, bool setLinkType = false, bool isDriveRoot = false);
...
inline void QFileSystemMetaData::fillFromFindData(WIN32_FIND_DATAA &findData, bool setLinkType, bool isDriveRoot)
{
