...
INCLUDEPATH *= $$QT_SOURCE_TREE/include/qtgui
...
embedded|contains(DEFINES, ONTIME_RTOS):include(embedded/embedded.pri)
symbian {
...
include(egl/egl.pri)
win32:!wince*:!contains(DEFINES, ONTIME_RTOS) DEFINES += QT_NO_EGL
#embedded: QT += network
